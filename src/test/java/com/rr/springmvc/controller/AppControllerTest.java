...
import com.rr.springmvc.controller.AppController;
import com.rr.springmvc.model.Employee;
import com.rr.springmvc.service.EmployeeService;
...
public class AppControllerTest {
	...
	public void listEmployees(){
		...
		Assert.assertEquals(appController.listEmployees(model), "employees/allemployees");
	...
	public void newEmployee(){
		Assert.assertEquals(appController.newEmployee(model), "employees/registration");
	...
	public void saveEmployeeWithValidationError(){
		...
		Assert.assertEquals(appController.saveEmployee(employees.get(0), result, model), "employees/registration");
	}
	...
	public void saveEmployeeWithSuccess(){
		...
		doNothing().when(service).saveEmployee(any(Employee.class));
		Assert.assertEquals(appController.saveEmployee(employees.get(0), result, model), "employees/success");
	...
	public void editEmployee(){
		...
		Assert.assertEquals(appController.editEmployee(anyString(), model), "employees/registration");
		Assert.assertNotNull(model.get("employee"));
	...
	public void updateEmployeeWithValidationError(){
		...
		Assert.assertEquals(appController.updateEmployee(employees.get(0), result, model,""), "employees/registration");
	}
	...
	public void updateEmployeeWithSuccess(){
		...
		when(service.isEmployeeSsnUnique(anyInt(), anyString())).thenReturn(true);
		doNothing().when(service).updateEmployee(any(Employee.class));
		Assert.assertEquals(appController.updateEmployee(employees.get(0), result, model, ""), "employees/success");
	...
	public void deleteEmployee(){
		...
		Assert.assertEquals(appController.deleteEmployee("123"), "redirect:/employees/list");
	}
